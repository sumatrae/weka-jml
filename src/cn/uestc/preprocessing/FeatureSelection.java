...
public class FeatureSelection {
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println("++++++++++Example 3: Feature Selection via weka.++++++++");

		System.out.println("Step 1. 读取数据...");
		String fn ="D:/weka-3-7-7/weka-3-7-7/data/iris.arff";
        ...
        ASEvaluation ae = new InfoGainAttributeEval(); //change here: different feature selection methods                      
